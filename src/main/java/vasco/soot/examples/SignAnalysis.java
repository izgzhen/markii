...
public class SignAnalysis extends ForwardInterProceduralAnalysis<SootMethod, Unit, Map<Local, SignAnalysis.Sign>> {
	...
	public Map<Local, SignAnalysis.Sign> normalFlowFunction(
            VascoContext<SootMethod, Unit, Map<Local, Sign>> context, Unit unit,
	...
	public Map<Local, SignAnalysis.Sign> callEntryFlowFunction(
            VascoContext<SootMethod, Unit, Map<Local, Sign>> context, SootMethod calledMethod, Unit unit,
            Map<Local, SignAnalysis.Sign> inValue) {
	...
	@Override
	public Map<Local, SignAnalysis.Sign> callExitFlowFunction(VascoContext<SootMethod, Unit, Map<Local, Sign>> context, SootMethod calledMethod, Unit unit, Map<Local, SignAnalysis.Sign> exitValue) {
	...
	@Override
	public Map<Local, SignAnalysis.Sign> callLocalFlowFunction(VascoContext<SootMethod, Unit, Map<Local, Sign>> context, Unit unit, Map<Local, SignAnalysis.Sign> inValue) {
