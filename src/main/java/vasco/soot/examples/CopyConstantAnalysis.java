...
public class CopyConstantAnalysis extends ForwardInterProceduralAnalysis<SootMethod, Unit, Map<Local, Constant>> {
	...
	@Override
	public Map<Local, Constant> normalFlowFunction(VascoContext<SootMethod, Unit, Map<Local, Constant>> context, Unit unit,
	...
	@Override
	public Map<Local, Constant> callEntryFlowFunction(VascoContext<SootMethod, Unit, Map<Local, Constant>> context, SootMethod calledMethod, Unit unit, Map<Local, Constant> inValue) {
	...
	@Override
	public Map<Local, Constant> callExitFlowFunction(VascoContext<SootMethod, Unit, Map<Local, Constant>> context, SootMethod calledMethod, Unit unit, Map<Local, Constant> exitValue) {
	...
	@Override
	public Map<Local, Constant> callLocalFlowFunction(VascoContext<SootMethod, Unit, Map<Local, Constant>> context, Unit unit, Map<Local, Constant> inValue) {
