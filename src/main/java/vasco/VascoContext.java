 ...
 */
public class VascoContext<M,N,A> implements Context, Comparable<VascoContext<M,N,A>> {
	 ...
	 */
	public VascoContext(M method, DirectedGraph<N> cfg, boolean reverse) {
	 ...
	 */
	@Override
	public int compareTo(VascoContext<M,N,A> other) {
