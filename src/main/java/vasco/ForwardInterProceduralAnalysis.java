...
public abstract class ForwardInterProceduralAnalysis<M,N,A> extends InterProceduralAnalysis<M,N,A> {
	 ...
	 * @return
	 */
	protected VascoContext<M, N, A> initContextForPhantomMethod(M method, A entryValue) {
		VascoContext<M, N, A> context = new VascoContext<M, N, A>(method);
	 ...
	 */
	public abstract A normalFlowFunction(VascoContext<M, N, A> context, N node, A inValue);
	 ...
	 */
	public abstract A callEntryFlowFunction(VascoContext<M,N,A> context, M targetMethod, N node, A inValue);
	 ...
	 */
	public abstract A callExitFlowFunction(VascoContext<M,N,A> context, M targetMethod, N node, A exitValue);
	 ...
	 */
	public abstract A callLocalFlowFunction(VascoContext<M,N,A> context, N node, A inValue);
