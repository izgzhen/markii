...
public class PointsToAnalysis extends OldForwardInterProceduralAnalysis<SootMethod,Unit,PointsToGraph> {
	 ...
	 */
	@Override
	protected PointsToGraph flowFunction(VascoContext<SootMethod,Unit,PointsToGraph> context, Unit unit, PointsToGraph in)
	{
	 ...
	 * into account.
	 */
	protected PointsToGraph handleInvoke(VascoContext<SootMethod,Unit,PointsToGraph> callerContext, Stmt callStmt,
